...
wget https://github.com/xiaoxindada/SGSI-build-tool/releases/download/v11-1.4/SGSI-build-tool-11.tar
...
https://github.com/xiaoxindada/SGSI-build-tool/releases/download/v11-1.6/SGSI-build-tool-11.tarcd ..
